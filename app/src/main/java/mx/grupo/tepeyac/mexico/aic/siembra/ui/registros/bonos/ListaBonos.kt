package mx.grupo.tepeyac.mexico.aic.siembra.ui.registros.bonos
...
class ListaBonos : Fragment() {
    private lateinit var viewModel: ListaBonosViewModel
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        viewModel = ViewModelProvider(this).get(ListaBonosViewModel::class.java)
    }
